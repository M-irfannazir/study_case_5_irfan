...
Ini adalah percabangan (conditional statement) yang menentukan tarif per jam berdasarkan jenis kendaraan. Program mengecek kondisi satu per satu: kalau kendaraannya "mobil", tarif diset 5000; kalau "motor", tarif diset 3000.
